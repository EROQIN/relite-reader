...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'library.webdav.empty': 'No WebDAV books indexed yet.',
    'library.webdav.emptySearch': 'No matches in WebDAV books.',
    'library.webdav.missing': 'Missing',
    'library.webdav.hideMissing': 'Hide missing',
    ...
    'library.sort.recent': 'Recently opened',
    ...
    'reader.annotations.title': 'Highlights & Notes',
    'reader.annotations.subtitle': 'Capture passages and add notes for quick recall.',
    'reader.annotations.quote.label': 'Highlight',
    'reader.annotations.quote.placeholder': 'Highlight text',
    'reader.annotations.note.label': 'Note',
    'reader.annotations.note.placeholder': 'Add a note',
    'reader.annotations.color': 'Color',
    'reader.annotations.add': 'Add',
    'reader.annotations.empty': 'No highlights yet.',
    'reader.annotations.remove': 'Remove',
    'reader.annotations.capture': 'Use selection',
    'reader.annotations.export': 'Export',
    'reader.annotations.jump': 'Jump',
    'reader.search.placeholder': 'Search in book',
    'reader.search.label': 'Search in book',
    'reader.search.count': '{current}/{total} matches',
    'reader.search.empty': 'No matches',
    'reader.search.prev': 'Prev',
    ...
    'reader.format.loading': 'Loading content...',
    'reader.format.error': 'Unable to load this file.',
    'reader.format.webdavAuth': 'Sign in to load WebDAV content.',
  ...
  'zh-CN': {
    ...
    'library.webdav.empty': '暂无 WebDAV 图书。',
    'library.webdav.emptySearch': 'WebDAV 图书中没有匹配结果。',
    'library.webdav.missing': '已缺失',
    'library.webdav.hideMissing': '隐藏缺失项',
    ...
    'reader.annotations.title': '高亮与笔记',
    'reader.annotations.subtitle': '标记段落并添加笔记，便于快速回顾。',
    'reader.annotations.quote.label': '高亮',
    'reader.annotations.quote.placeholder': '高亮文本',
    'reader.annotations.note.label': '笔记',
    'reader.annotations.note.placeholder': '写下笔记',
    'reader.annotations.color': '颜色',
    'reader.annotations.add': '添加',
    'reader.annotations.empty': '暂无高亮。',
    'reader.annotations.remove': '移除',
    'reader.annotations.capture': '使用选中内容',
    'reader.annotations.export': '导出',
    'reader.annotations.jump': '跳转',
    'reader.search.placeholder': '在书中搜索',
    'reader.search.label': '在书中搜索',
    'reader.search.count': '{current}/{total} 条匹配',
    'reader.search.empty': '没有匹配',
    ...
    'reader.format.loading': '正在加载内容…',
    'reader.format.error': '无法加载该文件。',
    'reader.format.webdavAuth': '登录后可加载 WebDAV 内容。',
