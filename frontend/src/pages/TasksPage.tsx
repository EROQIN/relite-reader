...
type FilterKey = 'all' | 'queued' | 'running' | 'success' | 'error'
    ...
    <section className="tasks-page">
      <header className="panel">
        <div className="tasks-panel-header">
          <div>
            <span className="overline">{t('tasks.page.overline')}</span>
            <h1>{t('tasks.page.title')}</h1>
            <p className="muted">{t('tasks.page.subtitle')}</p>
          </div>
        ...
        <div className="tasks-filter">
          {(['all', 'queued', 'running', 'success', 'error'] as FilterKey[]).map(
            (key) => (
              <button
                key={key}
                className="button"
